...
<div class="rel">
  <span
    class="
      abs fg:gray-50 fg:input-label:has(+:focus) left:0 pointer-events:none top:0 transform:top|left
  ...
  <input
    ...
    required
    class="
      bg:input-bg bg:input-hover-bg:hover bg:input-hover-bg:focus fg:transparent::placeholder fg:gray-60:valid::placeholder fg:input-placeholder:focus::placeholder outline:input-outline w:full
